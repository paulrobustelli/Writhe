...
trajectory = "./Ab40-a99SBdisp-Traj.dcd"
pdb = "./Ab40.pdb"
outdir='./outdir/'
...
def main():   
    ...
    plot_project_time(WPC1, WPC2, time=200, title= 'Writhe PCA: ab40, time') # title matters because 1st letter is in output png
    plot_free_energy(WPC1, WPC2, n_cmap, title="Writhe PCA: ab40, Free Energy,")
    plot_project_rg(WPC1, WPC2, title= "Writhe PCA: ab40, Rg")
    
    CPC1, CPC2 = pca(c_model_input)
    plot_project_time(CPC1, CPC2, time=200, title= 'Contact Distances PCA: ab40, time')
    plot_free_energy(CPC1, CPC2, n_cmap, title="Contact Distances PCA: ab40, Free Energy")
    plot_project_rg(CPC1, CPC2, title= "Contact Distances PCA: ab40, Rg")
